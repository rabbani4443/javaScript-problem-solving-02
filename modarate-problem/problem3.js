...
function printDetails(person){
    ...
    const nam = person.name ? person.name : "nai";
    const age = person.age ? person.age : 'nai';
    const email = person.email ? person.email : "nai";
    const wife  = person.wife  ? person.wife  : 'nai';

    const totla = 'Amar nam ' + nam + ", amar boyos " + age + ', email ' + email + ' ' + wife;
     return totla;
  }
}
